...
mysql -u root -D "hpc_project" -e "CREATE TABLE trump_executive_order (process_time TIMESTAMP, status_time TIMESTAMP DEFAULT '1970-01-01 00:00:01', status VARCHAR(200), sentiment VARCHAR(50));";
